...
// banner below shows only until this moment, then disappears on its
// own — no need to delete any code. Timezone here is KST (+09:00);
// change the string to your actual go-live time.
